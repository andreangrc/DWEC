...
const COLOR_COMP = "purple";
const COLOR_COMP_LIT = "purple";
const COLOR_DOT = "black";
const COLOR_PLAY = "indigo";
const COLOR_PLAY_LIT = "RebeccaPurple";
...
function drawBoard() {
    const color_fondo = "thistle";
    ctx.fillStyle = color_fondo;
    ctx.strokeStyle = color_borde_fondo;
